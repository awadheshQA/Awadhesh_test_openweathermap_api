...
The Original directory 'Awadhesh_test_openweathermap_api'or zip/tar after extraction it  contains two testing frameworks( Rest_assured_test and Selenium_Test_Awadhesh ) and Readme_docs file to test 
...
Both the frameworks having Readme file how to run and what about all test and more details can be get from README file
...
Awadhesh_test_openweathermap_api
   Rest_assured_test   ( To Test https://openweathermap.org/current weather API)
	...
	RestAussuredAddidas --> This is the Main directory on test framework which contains all required libraries
